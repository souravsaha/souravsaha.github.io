...
<details>
<summary><span style="color:Maroon;"> Dependency to run the notebook!</span></summary>
<span class="abstract-text" style="font-size:.90em; color:Maroon; text-align: justify">You need install pyserini and the programs written in https://github.com/GarfieldLyu/RankingExplanation </span>
</details>
